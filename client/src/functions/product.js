...
export const getCountProduct = async (count) => {
    return await axios
...
export const getSlugProduct = async (slug) => {
    return await axios
...
export const productStar = async (productId, star, email, authtoken) => {
    return await axios
        .put(`${process.env.REACT_APP_API}/product/star/${productId}`, { star, email },{
            headers: {
                authtoken
            }
        })
